...
```{r PCAdata}
# import metadata
path <- "/work/nvp29/Size_fractionation/Sizefrac_R/data/sizefrac_metadata.csv"
meta <- read.csv(path)
...
<<<<<<< HEAD
ggsave("/work/nvp29/Size_fractionation/Sizefrac_R/data/pca_test.png", p)
```
=======
ggsave("/work/nvp29/Size_fractionation/Sizefrac_R/data/pca_test.png", scatter_plot)
```
>>>>>>> 091fdf3c8c4454734ade436c29be955a3ca92913
